...
final class DummyIntentAction: IntentAction {
    ...
    static func intent(withInput input: DummyIntentAction.InputType) -> DummyIntent? {
        return DummyIntent()
    }
    
    static func input(fromIntent intent: DummyIntent) -> DummyIntentAction.InputType? {
        return NoInput.noInput
    }
